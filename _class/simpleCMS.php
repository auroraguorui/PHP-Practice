...
ADMIN_FORM;
  ...
  public function connect() {
    $this->link = mysqli_connect($this->host,$this->username,$this->password) or die("Could not connect. " . mysql_error());
    mysqli_select_db($this->link, $this->table) or die("Could not select database. " . mysql_error());
